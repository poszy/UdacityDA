...
#This function adds peoples names,age and months to a list and returns it.
...
def get_april_birthdays(people):
    ...
    for person in people:
        # i.month == loop through the persons object
        # If it is equal to April, + 1 to that persons age.
