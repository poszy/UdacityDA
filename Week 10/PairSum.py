...
# Given and input array and a target value (integer) find two values in teh aray whos sum is equal to the target value.
# solve this problem without using extra space. you can ssume the array has unique values and will never have more than one solution
