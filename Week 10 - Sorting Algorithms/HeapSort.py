...
# HeapSort is an inplace sorting algorithm that treats an array like a binary tree and moves the largest values to the end of the heap until the full
# array is sorted

# The main steps are
## convert the array into a maxheap ( a complete binary tree with decreaing values)
## swap the top element with the last elemen in the array ( putting it in its correct final position
